...
// TAKEN AND ALTERED FROM "https://github.com/0xSebastian/VapeLite-ClickGui/blob/main/clickgui/RenderUtil.java"
...
//        GL11.glEnable(GL_MULTISAMPLE);
    ...
    public static void drawRect(float x1, float y1, double x2, float y2, Color color) {
        Gui.drawRect((int) x1, (int) y1, (int) x2, (int) y2, color.getRGB());
    }

    public static void drawRoundedRect(float x1, float y1, float x2, float y2, final float round, final int color) {
